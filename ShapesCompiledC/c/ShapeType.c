...
RTIXCdrSampleAccessInfo *ShapeTypeExtended_get_sample_access_info()
{
    ...
    (RTIXCdrUnsignedLong) RTIXCdrUtility_pointerToULongLong(&((ShapeTypeExtended *)NULL)->fillKind);

    ShapeTypeExtended_g_memberAccessInfos[1].bindingMemberValueOffset[0] = 
    (RTIXCdrUnsignedLong) RTIXCdrUtility_pointerToULongLong(&((ShapeTypeExtended *)NULL)->angle);
