...
> make -f makefile_ShapeType_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ShapeType_x64Linux4gcc7.3.0 DEBUG=1
...
Run /home/pauls/rti_connext_dds-6.1.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/ShapeType_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/ShapeType_subscriber -d <domain_id> -s <sample_count>
